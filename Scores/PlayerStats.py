...
class PlayerStats(object):
    def __init__(self, statswrapper, player_cell, position, year, week):
        ...
        self.player = self.statswrapper.find_player(self.player_name, position)
    ...
    def update_cell_color(self, player_row, team_name, year, week):
        ...
        #official_name = self.statswrapper.get_standard_team_name(team_name)
        #game = self.statswrapper.find_game(official_name, year, week)
        #if game is None:
